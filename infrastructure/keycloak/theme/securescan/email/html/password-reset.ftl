      ...
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:600px;background-color:#0a1824;border:1px solid rgba(143,211,220,0.18);border-radius:24px;box-shadow:0 20px 40px rgba(0,0,0,0.28);overflow:hidden;">
        ...
        <tr>
          <td style="padding:0 32px 32px;">
            <h1 style="margin:12px 0 16px;color:#f8fcff;font-size:30px;line-height:1.2;text-align:center;">${msg("passwordResetHeading")}</h1>
            <p style="margin:0 0 14px;color:#eff7fb;font-size:16px;line-height:1.7;text-align:center;">${msg("passwordResetLead")}</p>
            <p style="margin:0 0 24px;color:#9eb2bf;font-size:15px;line-height:1.7;text-align:center;">${msg("passwordResetBody")}</p>
            ...
            <div style="padding:16px 18px;border-radius:18px;background-color:rgba(16,37,53,0.82);border:1px solid rgba(143,211,220,0.18);">
              <p style="margin:0 0 8px;color:#eff7fb;font-size:14px;font-weight:700;">${msg("passwordResetExpiryTitle")}</p>
              <p style="margin:0;color:#9eb2bf;font-size:14px;line-height:1.7;">${msg("passwordResetExpiry", linkExpirationFormatter(linkExpiration))}</p>
            </div>
            <p style="margin:18px 0 0;color:#9eb2bf;font-size:13px;line-height:1.7;text-align:center;">${msg("passwordResetIgnore")}</p>
          </td>
        </tr>
      </table>
    </td>
